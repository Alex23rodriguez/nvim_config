return {
  ...
  },
  {
    ...
    -- lazy = true,
    -- keys = {
    --   { 'L', require('before').jump_to_last_edit },
    --   { 'Y', require('before').jump_to_next_edit },
    -- },
    config = function()
      ...
      vim.keymap.set('n', 'L', before.jump_to_last_edit, {})

      -- Jump to next entry in the edit history
      vim.keymap.set('n', 'Y', before.jump_to_next_edit, {})
